...
class Toolkit:
    ...
    def get_china_stock_data(
        ...
        try:
            ...
            from jiuwenfintech.data.interface import get_china_stock_data_unified
    ...
    def get_china_market_overview(
        ...
        """
        try:
            from jiuwenfintech.data.providers.china.tushare import get_tushare_adapter
...
"""
    ...
    def get_realtime_stock_news(
        ...
        """
        from jiuwenfintech.data.realtime_news_utils import get_realtime_stock_news
    ...
    def get_china_fundamentals(
        ...
        try:
            ...
            from jiuwenfintech.data.optimized_china_data import OptimizedChinaDataProvider
    ...
    def get_hk_stock_data_unified(
        ...
        try:
            from jiuwenfintech.data.interface import get_hk_stock_data_unified
    ...
    @staticmethod
    async def get_stock_fundamentals_unified(
        ...
        try:
            ...
            if is_china:
                ...
                try:
                    ...
                    current_price_data = await get_china_stock_data_unified(ticker, recent_start_date, recent_end_date)
                ...
                try:
                    ...
                    fundamentals_data = await analyzer._generate_fundamentals_report(ticker, current_price_data,
                                                                                     analysis_modules)
                ...
                if not hk_data_success:
                    try:
                        from jiuwenfintech.data.interface import get_hk_stock_info_unified
...
"""
                ...
                try:
                    from jiuwenfintech.data.interface import get_fundamentals_openai
...
"""
    ...
    @staticmethod
    async def get_stock_market_data_unified(
        ...
        自动识别股票类型（A股、港股、美股）并调用相应的数据源获取价格和技术指标数据
         ...
         重要：系统会自动扩展日期范围到配置的回溯天数（通常为365天），以确保技术指标计算有足够的历史数据。
        ...
        try:
            ...
            if is_china:
                ...
                try:
                    from jiuwenfintech.data.interface import get_china_stock_data_unified
                    stock_data = await get_china_stock_data_unified(ticker, start_date, end_date)
        ...
        try:
            ...
            if is_china or is_hk:
                ...
                try:
                    ...
                    from jiuwenfintech.data.providers.china.akshare import AKShareProvider
                ...
                try:
                    ...
                    from jiuwenfintech.data.interface import get_google_news
                ...
                try:
                    from jiuwenfintech.data.interface import get_finnhub_news
...
"""
                ...
                try:
                    from jiuwenfintech.data.interface import get_reddit_sentiment
