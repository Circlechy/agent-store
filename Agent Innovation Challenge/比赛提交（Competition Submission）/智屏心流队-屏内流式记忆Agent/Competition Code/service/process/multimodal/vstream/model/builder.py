...
import torch
from service.process.multimodal.vstream.model import VStreamLlamaForCausalLM, VStreamConfig
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", **kwargs):
    ...
    if 'vstream' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            tokenizer = None
            model = VStreamLlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, trust_remote_code=True, **kwargs)
    else:
        # Load language model
