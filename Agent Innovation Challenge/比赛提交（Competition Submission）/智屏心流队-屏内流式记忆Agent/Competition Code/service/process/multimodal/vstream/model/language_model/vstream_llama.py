...
from transformers import AutoConfig, AutoModelForCausalLM, \
    LlamaConfig, LlamaModel, LlamaForCausalLM, LlamaPreTrainedModel, GenerationMixin
from transformers.modeling_outputs import CausalLMOutputWithPast
from service.process.multimodal.vstream.model.vstream_arch import VStreamMetaModel, VStreamMetaForCausalLM
...
class VStreamLlamaModel(VStreamMetaModel, LlamaPreTrainedModel):
...
class VStreamLlamaForCausalLM(VStreamMetaForCausalLM, LlamaPreTrainedModel, GenerationMixin):
    config_class = VStreamConfig
