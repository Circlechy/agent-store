...
from transformers import AutoConfig, AutoModelForCausalLM, \
    LlamaConfig, LlamaModel, LlamaForCausalLM, GenerationMixin
from transformers.modeling_outputs import CausalLMOutputWithPast
from service.search.vstream.model.vstream_arch import VStreamMetaModel, VStreamMetaForCausalLM
...
class VStreamLlamaForCausalLM(VStreamMetaForCausalLM, LlamaForCausalLM, GenerationMixin):
    config_class = VStreamConfig
    ...
    def forward(
        ...
        cache_position: Optional[torch.LongTensor] = None,  # 新增参数
        ...
        return super().forward(
            ...
            cache_position=cache_position,  # 传递参数
