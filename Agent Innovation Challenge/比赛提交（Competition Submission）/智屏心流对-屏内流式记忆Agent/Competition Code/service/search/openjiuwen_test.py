...
# os.environ.setdefault('API_KEY', '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')
os.environ.setdefault('API_KEY', 'EMPTY')
os.environ.setdefault('MODEL_PROVIDER', 'openai')
# os.environ.setdefault('MODEL_NAME', 'qwen3-vl-235b-a22b-instruct')
