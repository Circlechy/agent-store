...
class BaseCompression(ProcessComponent, ABC):
    ...
    def __call__(self, context: Context, **kwargs: Any):
        ...
        self._compression(context, **kwargs)
        end_time = time.time()
    ...
    @abstractmethod
    def _compression(self, context: Context, **kwargs: Any) -> None:
        """compression data"""
        ...
    ...
    def _parse_input(self, context: Context, **kwargs: Any):
        ...
        try:
            ...
            raise ProcessorException(ErrorCode.EMBEDDING_PARAM_INVALID, str(ex)) from ex
