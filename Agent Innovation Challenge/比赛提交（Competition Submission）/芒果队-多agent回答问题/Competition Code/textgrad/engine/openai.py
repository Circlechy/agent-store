...
class ChatOpenAI(EngineLM, CachedEngine):
    ...
    def _generate_from_single_prompt(
        self, prompt: str, system_prompt: str=None, temperature=0.75, max_tokens=800, top_p=0.9, tools = None, file_path = "", memory=[]
    ):
...
class ChatAsyncOpenAI(EngineLM, CachedEngine):
    ...
    async def _generate_from_single_prompt(
        self, prompt: str, system_prompt: str=None, temperature=0.75, max_tokens=1200, top_p=0.9, tools = None, file_path = "", memory=[]
    ):
